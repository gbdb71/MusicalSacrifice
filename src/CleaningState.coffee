class CleaningState extends Phaser.State
  init: ->
    @game.controller.init()
    @createdAt = Date.now()

  create: ->
    pitch = @game.add.sprite(@game.world.centerX, @game.world.centerY, 'cleaning')
...
MusicalSacrifice.CleaningState = CleaningState
